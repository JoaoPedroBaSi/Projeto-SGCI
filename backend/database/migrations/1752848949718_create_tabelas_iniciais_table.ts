...
<<<<<<<< HEAD:back-end/database/migrations/1752848949718_create_tabelas_iniciais_table.ts
      // Usuário responsável (Médico pagando aluguel ou Paciente pagando consulta)
========
...
>>>>>>>> main:backend/database/migrations/1752848949718_create_tabelas_iniciais_table.ts
      table
        .integer('user_id')
        .unsigned()
        .notNullable()
...
<<<<<<<< HEAD:back-end/database/migrations/1752848949718_create_tabelas_iniciais_table.ts
      ...
      table.string('finalidade').notNullable() // 'Aluguel Sala', 'Consulta'
      
      // === ADICIONE ISSO ===
      table.string('descricao').nullable() // Detalhes extras
      table.string('forma_pagamento').nullable() // 'PIX', 'DINHEIRO'

      // Campos avançados (Mantivemos como nullable para não quebrar a lógica simples)
      table.string('entidade_origem').nullable()
...
>>>>>>>> main:backend/database/migrations/1752848949718_create_tabelas_iniciais_table.ts
  ...
  async down() {
<<<<<<<< HEAD:back-end/database/migrations/1752848949718_create_tabelas_iniciais_table.ts
    // Garantir que tabelas dependentes (filhos) sejam dropadas antes das tabelas pai
