...
export class TransacaoService {
...
): Promise<'CONCLUIDO'> { // Retorna o status de sucesso
  ...
  public async criarTransacaoAtendimento (atendimentoId: Number, userId: Number, clienteId: Number, profissionalId: Number, valorPagamento: Number) {
