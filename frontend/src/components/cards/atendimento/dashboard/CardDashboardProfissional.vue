...
<template>
  ...
  <div v-else-if="finalidade === 'grafico-pagamentos'" class="card">
    <div class="texto"><p>STATUS DE PAGAMENTOS</p></div>
  ...
  <div v-else-if="finalidade === 'grafico-genero'" class="card">
    <div class="texto"><p>PERFIL POR GÊNERO</p></div>
    <div class="chart-container">
  ...
  <div v-else-if="finalidade === 'grafico-idade'" class="card">
    <div class="texto"><p>FAIXA ETÁRIA DOS CLIENTES</p></div>
    <div class="chart-container">
      <GraficoPizza v-if="chartData" :chartData="chartData" />
    </div>
  </div>
  ...
  <div v-else-if="finalidade === 'agenda'" class="card">
    ...
    <div class="infos">
      <p><strong>{{ qtdAgendadas || 0 }}</strong> consultas na sua <RouterLink to="/profissional/agenda">agenda</RouterLink> de hoje</p>
      <p><strong>{{ qtdFinalizadas || 0 }}</strong> consultas no seu <RouterLink to="/profissional/historico">histórico</RouterLink></p>
