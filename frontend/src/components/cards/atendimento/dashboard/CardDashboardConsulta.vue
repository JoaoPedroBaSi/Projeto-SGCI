...
// Helper para evitar repetição de Date
...
<template>
  <div class="card" v-if="props.consulta.status === 'CONFIRMADO'">
    <header class="cabecalho">
      <img src="https://plus.unsplash.com/premium_photo-1689568126014-06fea9d5d341?fm=jpg&q=60&w=300" alt="Foto do Profissional" class="foto">
      <div class="titulo">
...
<style scoped>
  ...
  .status-verde { background: #e6f4ea; color: #1e7e34; }
  .status-vermelho { background: #fce8e6; color: #d93025; }
  .status-padrao { background: #f1f3f4; color: #5f6368; }
