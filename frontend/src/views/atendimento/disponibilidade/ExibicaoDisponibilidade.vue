...
<template>
  ...
  <div class="barra-pesquisa">
    <input type="search" v-model="busca" placeholder="Digite o nome do profissional (mín. 3 letras)..."
  ...
  <div v-if="agendaFiltrada" class="campo-exibicao">
    <div v-for="dia in diasSemana" :key="dia" class="dia-coluna">
      ...
      <div class="lista-horarios">
        <div v-for="horario in agendaFiltrada.agenda[dia]" :key="horario.id" class="card-horario">
