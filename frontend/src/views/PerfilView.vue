            ...
            <div class="form-col">
              <div class="row-dupla">
                ...
                <div class="input-wrapper pequeno">
                  <label>UF</label>
                  <input type="text" v-model="user.conselho_uf" :disabled="!isEditing" class="input-pill"
                    maxlength="2" />
                </div>
              </div>
            </div>
    ...
    <div v-if="showPasswordModal" class="modal-overlay" @click.self="closePasswordModal">
      <div class="modal-card">
        ...
        <div class="modal-body">
          <div class="input-wrapper"><label>Senha Atual</label><input class="input-pill" type="password"
              v-model="passwordForm.currentPassword" /></div>
          <div class="input-wrapper"><label>Nova Senha</label><input class="input-pill" type="password"
              v-model="passwordForm.newPassword" /></div>
          <div class="input-wrapper"><label>Confirmar Senha</label><input class="input-pill" type="password"
              v-model="passwordForm.confirmPassword" /></div>
