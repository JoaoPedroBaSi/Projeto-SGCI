        ...
        <form @submit.prevent="cadastrar">
          ...
          <div class="row-dupla">
            ...
            <div class="input-group">
              ...
              <input type="password" v-model="form.confirmarSenha" placeholder="Confirmar a senha" required
                class="input-field" />
            </div>
          </div>
          ...
          <div class="row-dupla">
            <div class="input-group flex-2">
              ...
              <input type="text" v-model="form.registro_conselho" placeholder="Digite seu registro" required
                class="input-field" />
            </div>
            <div class="input-group flex-1">
              <label>UF</label>
              <input type="text" v-model="form.uf" placeholder="UF (Ex: RN)" maxlength="2" required
                class="input-field" />
            </div>
          </div>
          ...
          <div class="input-group">
            ...
            <textarea v-model="form.biografia" placeholder="Adicione aqui uma breve descrição sobre você"
          ...
          <div class="input-group">
            ...
            <div class="file-upload-wrapper">
              ...
              <span class="file-name">{{ form.comprovante ? form.comprovante.name : 'Nenhum arquivo selecionado'
                }}</span>
